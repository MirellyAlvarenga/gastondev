      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
        <div>
          ...
          <div className="space-y-4">
            <div className="flex items-center border border-gray-500 p-3 rounded-lg max-w-sm mx-auto md:mx-0">
              <div className="mr-4">
                <svg
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                type="email"
                name="user_email"
                placeholder="mirellypego@gmail.com"
                className="w-full bg-transparent border border-gray-500 px-3 py-2"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-transparent border border-gray-500 px-3 py-3 h-36"
                required
              />
            </div>
